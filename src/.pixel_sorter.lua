-- bug: this is seriously broken. Only works when your sprite is the rightmost you have open.
...
sorter.pixel_sort = function(lower, upper)
    ...
    for row_number = 0, row_count, 1 do
        ...
        -- feat: 1. enable generic sorting criteria 2. don't allow hue_from_pixel when in grayscale mode
